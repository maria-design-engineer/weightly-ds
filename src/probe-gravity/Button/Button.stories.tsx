...
/**
 * Ось State. Hover нарисован в ките осью, а в коде это рантайм: карточка ниже
 * подставляет заливку Base/Generic Hover переменной Gravity, курсор для этого не нужен.
 */
export const States: Story = {
  render: (args) => (
    <Row>
      ...
      <Cell label="Hover">
        <span style={{ '--g-button-background-color': 'var(--g-color-base-generic-hover)' } as CSSProperties}>
          <Button {...args} content="Кнопка" />
        </span>
      </Cell>
      <Cell label="Selected">
