...
const ICONS = { done: Check, failed: Xmark, skipped: Minus, 'not-started': CircleDashed }

const TITLES = {
  done: 'Подъём выполнен',
  failed: 'Подъём неуспешен',
  skipped: 'Подъём пропущен',
  'not-started': 'Подъём не начат',
}
...
/** Отметка одного подъёма: галка, крест, прочерк или пунктирный круг. Подход и подъём — разные вещи. */
